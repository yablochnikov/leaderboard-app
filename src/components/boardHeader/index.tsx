    ...
    <div className="board__header">
      ...
      <div className="header__controls">
        <div className="header__navigate">
          <div className="header__controls-prev">
            <svg
              width="11"
              height="7"
              viewBox="0 0 11 7"
          ...
          <div className="header__controls-next">
            <svg
              width="11"
              height="7"
              viewBox="0 0 11 7"
        ...
        <div className="header__buttons">
          <CustomButton bgcolor="#F99746" text={'New day'} />
          <CustomButton bgcolor="#1E3CA9" text={'Add new User'} />
        </div>
      </div>
    </div>
  );
